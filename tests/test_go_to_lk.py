...
class TestBurgersGoToLk:
    def test_go_to_lk(self, driver):
        ...
        WebDriverWait(driver, 3).until(
            expected_conditions.visibility_of_element_located((By.XPATH, BurgersLocators.PROFILE)))

        lk_name = driver.find_element(By.XPATH, BurgersLocators.LK_NAME)
        assert lk_name.is_displayed() and lk_name.get_attribute('value') == 'Malkin_7'
